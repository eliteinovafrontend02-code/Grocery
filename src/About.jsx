...
const getCurrentTestimonials = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50/30 via-white to-orange-50/30 pt-24 overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[35vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center overflow-hidden">
        {/* Background Image */}
        ...
        {/* Animated Particles - hidden on mobile to reduce visual clutter/height pressure */}
        ...
        {/* Hero Content */}
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-20 py-12 sm:py-20">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-md px-3.5 sm:px-5 py-1.5 sm:py-2.5 rounded-full border border-white/20 mb-4 sm:mb-6 animate-fadeInUp">
              <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-emerald-400 rounded-full animate-pulse"></span>
              <span className="text-white/90 text-[10px] sm:text-xs md:text-sm font-medium tracking-wider">SINCE 2020</span>
              <span className="w-px h-3.5 sm:h-4 bg-white/20"></span>
              <span className="text-emerald-300 text-[10px] sm:text-xs font-medium">✦ Premium Quality</span>
            </div>

            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-tight mb-4 sm:mb-6 animate-fadeInUp" style={{ animationDelay: "0.1s" }}>
            ...
            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-8 animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
              Bringing farm-fresh, organic, and high-quality groceries straight to your doorstep with love and care.
            </p>

            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
              <Link to="/">
                <button className="group relative px-6 sm:px-10 py-2.5 sm:py-4 bg-white text-emerald-700 font-semibold rounded-full shadow-2xl hover:shadow-emerald-500/30 transition-all duration-500 hover:scale-105 flex items-center gap-2 sm:gap-3 overflow-hidden text-sm sm:text-base">
              ...
              <Link to="/contact">
                <button className="px-6 sm:px-10 py-2.5 sm:py-4 bg-white/10 backdrop-blur-md text-white font-semibold rounded-full border-2 border-white/30 hover:bg-white/20 transition-all duration-300 hover:scale-105 text-sm sm:text-base">
                  Get in Touch
                </button>
              </Link>
            </div>

            <div className="flex flex-wrap justify-center items-center gap-5 sm:gap-8 mt-6 sm:mt-10 animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
              <div className="flex items-center gap-2 sm:gap-3 text-white/70">
                <div className="flex -space-x-2">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-white/30 bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-[10px] sm:text-xs font-bold text-white">
                      {String.fromCharCode(65 + i)}
                    </div>
                  ))}
                </div>
                <span className="text-xs sm:text-sm">10K+ Trusted</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2 text-white/70">
                ...
                <span className="text-xs sm:text-sm ml-1 sm:ml-2">4.9/5 Rating</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden sm:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-2 text-white/40 animate-bounce">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 sm:-mt-12 relative z-20">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`group rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl sm:shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-2 animate-fadeInUp border hover:border-emerald-200/50 ${
                index % 2 === 0 
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center mb-2.5 sm:mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg ${
                  index % 2 === 0 
                ...
                <p className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-emerald-600 to-orange-500 bg-clip-text text-transparent">
                  {stat.value}
                </p>
                <p className="text-[11px] sm:text-sm text-gray-600 mt-1 font-medium">{stat.label}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-14 sm:py-28 px-4 sm:px-6 lg:px-20 -mt-4 sm:-mt-8 relative overflow-hidden">
        ...
        {/* Elegant Floating Orbs - hidden on mobile */}
        <div className="hidden sm:block absolute top-20 right-20 w-72 h-72 bg-emerald-200/20 rounded-full blur-3xl animate-float-slow"></div>
        <div className="hidden sm:block absolute bottom-20 left-20 w-72 h-72 bg-orange-200/20 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: "2s" }}></div>
        <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-emerald-300/10 rounded-full blur-3xl animate-pulse-slow"></div>

        <div className="relative z-10 max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-10 sm:mb-16">
            <div className="animate-fadeInUp">
              <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/70 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-2.5 rounded-full border border-white/60 shadow-lg hover:shadow-xl transition-all duration-500">
                <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
                <span className="text-emerald-700 text-[11px] sm:text-sm font-semibold tracking-widest uppercase">About Us</span>
                <span className="w-px h-4 sm:h-5 bg-gradient-to-b from-emerald-300 to-orange-300"></span>
                <span className="text-orange-500 text-[10px] sm:text-xs font-medium">✦ Premium Quality</span>
              </div>
            </div>
            
            <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mt-6 sm:mt-8 mb-3 sm:mb-4 animate-fadeInUp" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
              <div className="w-12 sm:w-20 h-0.5 bg-gradient-to-r from-transparent via-emerald-500 to-orange-500 rounded-full"></div>
              <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
              <div className="w-12 sm:w-20 h-0.5 bg-gradient-to-r from-orange-500 to-transparent via-emerald-500 rounded-full"></div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            ...
            <div className="space-y-5 sm:space-y-8">
              ...
              <div className="relative animate-fadeInUp group" style={{ animationDelay: "0.1s" }}>
                <div className="absolute -top-2 -left-3 text-5xl sm:text-6xl text-emerald-200/40 font-serif leading-none">"</div>
              ...
              {/* Second Paragraph */}
              <div className="relative animate-fadeInUp pl-6 sm:pl-8" style={{ animationDelay: "0.2s" }}>
                ...
                <div className="flex items-center gap-2 mt-3">
                  ...
                  <span className="text-xs sm:text-sm text-gray-500 font-medium">4.9/5 Rating</span>
                </div>
              </div>
              
              {/* Third Paragraph */}
              <div className="animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
                <div className="relative bg-white/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-white/70 shadow-lg hover:shadow-xl transition-all duration-500 group">
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/50 to-orange-50/50 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              {/* Feature Grid */}
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3 animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
                {[
                  ...
                  <div 
                    key={i} 
                    className={`${item.bg} backdrop-blur-sm rounded-lg sm:rounded-xl p-2.5 sm:p-3 flex items-center gap-2.5 sm:gap-3 transition-all duration-500 hover:scale-105 hover:shadow-lg cursor-pointer group border border-white/50`}
                  >
                    <span className="text-lg sm:text-xl group-hover:scale-110 transition-transform duration-300">{item.icon}</span>
                    <span className="text-xs sm:text-sm font-semibold text-gray-700 group-hover:${item.color} transition-colors">
                      {item.label}
                    </span>
                  </div>
                ))}
              ...
              <div className="animate-fadeInUp" style={{ animationDelay: "0.5s" }}>
                <Link to="/">
                  <button className="group relative px-6 sm:px-8 py-2.5 sm:py-3.5 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 flex items-center gap-2 sm:gap-3 overflow-hidden text-sm sm:text-base">
                    <span className="relative z-10 font-medium tracking-wide">Back to Home</span>
                    <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-2 group-hover:rotate-12 transition-all duration-300 relative z-10" />
            ...
            <div className="relative animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
              ...
              <div className="hidden sm:block absolute -top-12 -right-12 w-48 h-48 bg-emerald-200/30 rounded-full blur-2xl animate-float-slow"></div>
              <div className="hidden sm:block absolute -bottom-12 -left-12 w-48 h-48 bg-orange-200/30 rounded-full blur-2xl animate-float-slow" style={{ animationDelay: "1.5s" }}></div>
              
              {/* Floating Badges */}
              <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 z-20 animate-float-slow" style={{ animationDelay: "0.5s" }}>
                <div className="bg-white/95 backdrop-blur-md px-2.5 sm:px-4 py-1.5 sm:py-2.5 rounded-xl sm:rounded-2xl shadow-xl border border-white/60">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center">
                      <Leaf className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                    </div>
                    <div>
                      <p className="text-[11px] sm:text-sm font-bold text-gray-800">100% Fresh</p>
                      <p className="text-[8px] sm:text-[10px] text-gray-500">Farm to Table</p>
                    </div>
                  </div>
                </div>
              </div>
              
              <div className="absolute -bottom-2 -left-2 sm:-left-4 z-20 animate-float-slow" style={{ animationDelay: "1.2s" }}>
                <div className="bg-white/95 backdrop-blur-md px-2.5 sm:px-4 py-1.5 sm:py-2.5 rounded-xl sm:rounded-2xl shadow-xl border border-white/60">
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center">
                      <Truck className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                    </div>
                    <div>
                      <p className="text-[11px] sm:text-sm font-bold text-gray-800">Free Delivery</p>
                      <p className="text-[8px] sm:text-[10px] text-gray-500">Above ₹499</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Main Image */}
              <div className="relative bg-gradient-to-br from-emerald-50/90 to-orange-50/90 p-2 sm:p-3 rounded-2xl sm:rounded-3xl shadow-2xl border border-white/60 hover:shadow-3xl transition-all duration-700 group">
                <div className="relative overflow-hidden rounded-xl sm:rounded-2xl">
                  <img 
                    src="/abanner.webp" 
                    alt="Our Story" 
                    className="w-full h-[220px] sm:h-[400px] object-cover transition-all duration-1000 group-hover:scale-110"
                    onError={(e) => {
                ...
                {/* Year Badge */}
                <div className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-300">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-white/20 flex items-center justify-center">
                      <span className="text-sm sm:text-lg">✦</span>
                    </div>
                    <div>
                      <p className="text-lg sm:text-2xl font-bold leading-none">2020</p>
                      <p className="text-[8px] sm:text-[10px] opacity-80 tracking-wider uppercase">Founded</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Trust Badges */}
              <div className="flex items-center justify-center gap-4 sm:gap-6 mt-6 sm:mt-6">
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    {[...Array(3)].map((_, i) => (
                      <div key={i} className="w-7 h-7 sm:w-9 sm:h-9 rounded-full border-2 border-white bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-[10px] sm:text-xs font-bold text-white shadow-lg">
                        {String.fromCharCode(65 + i)}
                      </div>
                    ))}
                  </div>
                  <span className="text-xs sm:text-sm font-medium text-gray-600">10K+ Trusted</span>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-gray-700 ml-1">4.9/5</span>
                </div>
              </div>
            </div>
          </div>
...
<section className="py-14 sm:py-28 px-4 sm:px-6 lg:px-20 -mt-8 sm:-mt-20 relative overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    <div className="hidden sm:block absolute top-0 left-0 w-96 h-96 bg-emerald-200/30 rounded-full blur-3xl animate-float-slow"></div>
    <div className="hidden sm:block absolute bottom-0 right-0 w-96 h-96 bg-orange-200/30 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: "1.5s" }}></div>
    <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-300/10 rounded-full blur-3xl animate-pulse-slow"></div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto">
    ...
    <div className="text-center mb-10 sm:mb-16">
      <div className="animate-fadeInUp">
        <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-2.5 rounded-full border border-white/60 shadow-lg hover:shadow-xl transition-all duration-500">
          <span className="w-2 h-2 bg-gradient-to-r from-emerald-500 to-orange-500 rounded-full animate-pulse"></span>
          <span className="text-emerald-700 text-[11px] sm:text-sm font-semibold tracking-widest uppercase">Core Values</span>
          <span className="w-px h-4 sm:h-5 bg-gradient-to-b from-emerald-300 to-orange-300"></span>
          <span className="text-orange-500 text-[10px] sm:text-xs font-medium">✦ Our Promise</span>
        </div>
      </div>
      ...
      <p className="text-gray-500 mt-4 sm:mt-6 max-w-2xl mx-auto animate-fadeInUp text-sm sm:text-base" style={{ animationDelay: "0.3s" }}>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 md:gap-8">
      {values.map((value, index) => (
        <div
          key={index}
          className="group relative bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-center shadow-lg sm:shadow-xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-4 animate-fadeInUp border border-white/50 overflow-hidden  "
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="relative inline-block">
              ...
              <div className={`relative w-14 h-14 sm:w-24 sm:h-24 rounded-xl sm:rounded-2xl bg-gradient-to-br ${value.gradient} flex items-center justify-center mx-auto mb-3 sm:mb-5 text-2xl sm:text-5xl transition-all duration-700 group-hover:scale-110 group-hover:rotate-6 shadow-lg sm:shadow-xl group-hover:shadow-2xl`}>
            ...
            <h3 className="text-sm sm:text-xl font-bold text-gray-800 mb-1.5 sm:mb-3 transition-all duration-300 group-hover:text-emerald-600 group-hover:scale-105">
              {value.title}
            </h3>
            
            {/* Description with Elegant Style */}
            <p className="text-xs sm:text-sm text-gray-500 leading-relaxed transition-all duration-300 group-hover:text-gray-600">
              {value.desc}
            </p>
    ...
    <div className="mt-10 sm:mt-16 text-center animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
      <div className="inline-flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-gray-400 text-xs sm:text-sm">
...
<section className="py-14 sm:py-28 px-4 sm:px-6 lg:px-20 -mt-8 sm:-mt-20 relative overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    {/* Animated Gradient Orbs - hidden on mobile */}
    <div className="hidden sm:block absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-200/20 rounded-full blur-3xl animate-float-slow"></div>
    <div className="hidden sm:block absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-200/20 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: "1.5s" }}></div>
    <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-emerald-300/10 rounded-full blur-3xl animate-pulse-slow"></div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto">
    ...
    <div className="text-center mb-10 sm:mb-16">
      <div className="animate-fadeInUp">
        <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-2.5 rounded-full border border-white/60 shadow-lg hover:shadow-xl transition-all duration-500">
          <span className="w-2 h-2 bg-gradient-to-r from-emerald-500 to-orange-500 rounded-full animate-pulse"></span>
          <span className="text-emerald-700 text-[11px] sm:text-sm font-semibold tracking-widest uppercase">Categories</span>
          <span className="w-px h-4 sm:h-5 bg-gradient-to-b from-emerald-300 to-orange-300"></span>
          <span className="text-orange-500 text-[10px] sm:text-xs font-medium">✦ Premium Selection</span>
        </div>
      </div>
      ...
      <p className="text-gray-500 mt-4 sm:mt-6 max-w-2xl mx-auto animate-fadeInUp leading-relaxed text-sm sm:text-base" style={{ animationDelay: "0.3s" }}>
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 md:gap-8">
      ...
      <Link to={categories[0].path}>
        <div className="group relative bg-gradient-to-br from-emerald-50 to-emerald-100/50 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-center cursor-pointer transition-all duration-700 hover:shadow-2xl hover:-translate-y-3 animate-fadeInUp border-2 border-emerald-200/30 hover:border-emerald-400/50 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="relative inline-block">
              ...
              <div className="text-3xl sm:text-6xl lg:text-7xl mx-auto mb-2.5 sm:mb-4 transition-all duration-700 group-hover:scale-110 group-hover:-rotate-3 group-hover:-translate-y-1 relative">
                {categories[0].icon}
              </div>
            </div>
            
            <p className="text-xs sm:text-base lg:text-lg font-bold text-emerald-700 transition-all duration-300 group-hover:scale-105">
              {categories[0].label}
            </p>
            ...
            <div className="mt-3 sm:mt-4 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-3 group-hover:translate-y-0">
      ...
      <Link to={categories[1].path}>
        <div className="group relative bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-center cursor-pointer transition-all duration-700 hover:shadow-2xl hover:-translate-y-3 animate-fadeInUp border-2 border-orange-200/30 hover:border-orange-400/50 overflow-hidden" style={{ animationDelay: "0.15s" }}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs sm:text-base lg:text-lg font-bold text-orange-700 transition-all duration-300 group-hover:scale-105">
              {categories[1].label}
            </p>
      ...
      <Link to={categories[2].path}>
        <div className="group relative bg-gradient-to-br from-red-50 to-red-100/50 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-center cursor-pointer transition-all duration-700 hover:shadow-2xl hover:-translate-y-3 animate-fadeInUp border-2 border-red-200/30 hover:border-red-400/50 overflow-hidden" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs sm:text-base lg:text-lg font-bold text-red-700 transition-all duration-300 group-hover:scale-105">
              {categories[2].label}
            </p>
      ...
      <Link to={categories[3].path}>
        <div className="group relative bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-center cursor-pointer transition-all duration-700 hover:shadow-2xl hover:-translate-y-3 animate-fadeInUp border-2 border-blue-200/30 hover:border-blue-400/50 overflow-hidden" style={{ animationDelay: "0.45s" }}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs sm:text-base lg:text-lg font-bold text-blue-700 transition-all duration-300 group-hover:scale-105">
              {categories[3].label}
            </p>
    ...
    {/* Bottom Decorative Elements */}
    <div className="mt-10 sm:mt-16 text-center animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
      <div className="inline-flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-gray-400 text-xs sm:text-sm">
        <span className="flex items-center gap-2">
...
<section className="py-14 sm:py-28 px-4 sm:px-6 lg:px-20 -mt-8 sm:-mt-20 relative overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    {/* Animated Gradient Orbs - hidden on mobile */}
    <div className="hidden sm:block absolute top-0 left-0 w-[600px] h-[600px] bg-emerald-200/20 rounded-full blur-3xl animate-float-slow"></div>
    <div className="hidden sm:block absolute bottom-0 right-0 w-[600px] h-[600px] bg-orange-200/20 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: "1.5s" }}></div>
    <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-emerald-300/10 rounded-full blur-3xl animate-pulse-slow"></div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto">
    ...
    <div className="text-center mb-10 sm:mb-16">
      <div className="animate-fadeInUp">
        <div className="inline-flex items-center gap-2 sm:gap-3 bg-white/80 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-2.5 rounded-full border border-white/60 shadow-lg hover:shadow-xl transition-all duration-500">
          <span className="w-2 h-2 bg-gradient-to-r from-emerald-500 to-orange-500 rounded-full animate-pulse"></span>
          <span className="text-emerald-700 text-[11px] sm:text-sm font-semibold tracking-widest uppercase">Testimonials</span>
          <span className="w-px h-4 sm:h-5 bg-gradient-to-b from-emerald-300 to-orange-300"></span>
          <span className="text-orange-500 text-[10px] sm:text-xs font-medium">✦ Real Stories</span>
        </div>
      </div>
    ...
    <div className="grid md:grid-cols-3 gap-4 sm:gap-8">
      {getCurrentTestimonials().map((testimonial, index) => (
       <div 
          ...
          className="group relative bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-lg sm:shadow-xl hover:shadow-3xl transition-all duration-700 hover:-translate-y-3 animate-fadeInUp border border-white/50 overflow-hidden"
          ...
          <div className="relative z-10">
            ...
            <div className="flex gap-1 mb-3 sm:mb-4">
              {[...Array(testimonial.rating || 5)].map((_, i) => (
                <Star 
                  key={i} 
                  className={`w-4 h-4 sm:w-5 sm:h-5 fill-orange-400 text-orange-400 transition-all duration-300 ${
            ...
            {/* Quote Text */}
            <p className="text-xs sm:text-base text-gray-700 leading-relaxed mb-5 sm:mb-6 italic group-hover:text-gray-800 transition-colors duration-300">
              "{testimonial.quote}"
            </p>
            
            {/* Customer Info */}
            <div className="flex items-center gap-3 sm:gap-4 pt-3 sm:pt-4 border-t border-gray-100/50">
              <div className="relative">
                <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-emerald-400 to-orange-400 flex items-center justify-center text-white font-bold text-base sm:text-xl shadow-lg group-hover:scale-110 transition-transform duration-500">
              ...
              <div>
                <p className="font-bold text-sm sm:text-base text-gray-800 group-hover:text-emerald-600 transition-colors duration-300">
                  {testimonial.name}
                </p>
            ...
            {/* Trust Badge */}
            <div className="mt-3 sm:mt-4 flex items-center gap-2 text-emerald-600/60 text-[11px] sm:text-xs">
    ...
    {totalPages > 1 && (
          <div className="mt-8 sm:mt-12 flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
            <button
              ...
              className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl border border-gray-200 hover:bg-emerald-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 text-xs sm:text-sm"
            >
              ← Previous
            </button>
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl transition-all duration-300 text-xs sm:text-sm ${
                  currentPage === i + 1
...
<section className="relative py-10 sm:py-16 px-4 sm:px-6 lg:px-20 overflow-hidden">
  ...
  <div className="absolute inset-0">
    ...
    {/* Animated Gradient Orbs - hidden on mobile */}
    <div className="hidden sm:block absolute top-0 left-0 w-[300px] h-[300px] bg-emerald-400/20 rounded-full blur-3xl animate-float-slow"></div>
    <div className="hidden sm:block absolute bottom-0 right-0 w-[300px] h-[300px] bg-orange-400/25 rounded-full blur-3xl animate-float-slow" style={{ animationDelay: "1.5s" }}></div>
    <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-emerald-300/10 rounded-full blur-3xl animate-pulse-slow"></div>
  ...
  <div className="relative z-10 max-w-4xl mx-auto text-center">
    <div className="animate-fadeInUp">
      ...
      <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-xl px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-white/20 mb-3 sm:mb-4 hover:border-white/40 transition-all duration-500 group">
        <div className="relative">
          <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-orange-300 animate-pulse" />
          <span className="absolute -top-1 -right-1 w-1.5 h-1.5 bg-orange-400 rounded-full animate-ping"></span>
        </div>
        <span className="text-white/90 text-[10px] font-medium tracking-wider">✦ Limited Time Offer</span>
        <div className="w-px h-4 bg-white/20"></div>
        <span className="text-orange-300 text-[9px] sm:text-[10px] font-semibold animate-pulse">Save 30%</span>
      </div>
      
      {/* Main Heading - Smaller */}
      <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2.5 sm:mb-3 animate-gradient-shift">
      ...
      <div className="flex items-center justify-center gap-3 mb-3 sm:mb-4">
        <div className="w-10 sm:w-12 h-0.5 bg-gradient-to-r from-transparent via-emerald-400 to-transparent rounded-full animate-pulse"></div>
        <div className="w-1.5 h-1.5 bg-orange-400 rounded-full animate-pulse"></div>
        <div className="w-10 sm:w-12 h-0.5 bg-gradient-to-r from-transparent via-orange-400 to-transparent rounded-full animate-pulse" style={{ animationDelay: "0.5s" }}></div>
      </div>
      
      {/* Description - Smaller */}
      <p className="text-xs sm:text-base md:text-lg text-white/80 max-w-2xl mx-auto mb-5 sm:mb-6 leading-relaxed animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
        ...
        <span className="block mt-1 text-[10px] sm:text-xs text-white/60">✓ Free Delivery • ✓ Fresh Guarantee • ✓ 24/7 Support</span>
      </p>
      
      {/* Buttons - Smaller */}
      <div className="flex flex-wrap justify-center gap-2.5 sm:gap-3 animate-fadeInUp" style={{ animationDelay: "0.3s" }}>
        <Link to="/">
          <button className="group relative px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-500 to-orange-500 text-white font-semibold rounded-full shadow-2xl hover:shadow-emerald-500/50 hover:shadow-orange-500/30 transition-all duration-500 hover:scale-105 flex items-center gap-2 overflow-hidden text-xs sm:text-sm">
        ...
        <Link to="/contact">
          <button className="group px-6 sm:px-8 py-2.5 sm:py-3 bg-white/10 backdrop-blur-xl text-white font-semibold rounded-full border-2 border-white/30 hover:border-white/60 transition-all duration-500 hover:scale-105 hover:bg-white/20 flex items-center gap-2 text-xs sm:text-sm">
      ...
      <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-white/10 animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-all duration-300 group-hover:scale-110">
              <Shield className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-300" />
            </div>
            <div className="text-left">
              <p className="text-white text-[11px] sm:text-xs font-semibold">100% Fresh</p>
              <p className="text-white/50 text-[9px] sm:text-[10px]">Guaranteed</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 group cursor-pointer">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-all duration-300 group-hover:scale-110">
              <Truck className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-orange-300" />
            </div>
            <div className="text-left">
              <p className="text-white text-[11px] sm:text-xs font-semibold">Free Delivery</p>
              <p className="text-white/50 text-[9px] sm:text-[10px]">On orders $50+</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <div className="text-left">
              <p className="text-white text-[11px] sm:text-xs font-semibold">4.9/5 Rating</p>
              <p className="text-white/50 text-[9px] sm:text-[10px]">50K+ Reviews</p>
            </div>
          </div>
        </div>
      </div>
