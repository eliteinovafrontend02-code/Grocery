// src/Components/pages/DairyProductsAndSnacks.jsx
...
import { products, categories, getProductsByCategory } from "../data/DairyProductsAndSnacksData";

// Custom Dairy & Snacks SVG Icons
const MilkIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M8 2h8v2l2 4v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8l2-4V2z" />
    <path d="M10 6h4" />
    <path d="M10 10h4" />
    <path d="M10 14h4" />
    <path d="M10 18h4" />
...
const CurdIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const CheeseIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const ButterIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const PaneerIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const ChipIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const CookieIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const NamkeenIcon = ({ className, style }) => (
  <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 8c1-2 3-3 6-3s5 1 6 3" />
    <path d="M4 10c1-1.5 3-2.5 8-2.5s7 1 8 2.5" />
    <path d="M4 14c1 1.5 3 2.5 8 2.5s7-1 8-2.5" />
          ...
          <div className={`${isFullScreen ? 'w-full h-full' : 'md:w-1/2'} relative bg-gradient-to-br from-emerald-50/50 to-orange-50/50 ${
            ...
            >
              ...
              <button 
                ...
                className="absolute top-2 right-2  lg:top-7 sm:top-4 sm:right-4 z-10 p-1.5 sm:p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:scale-110 transition-all duration-300 hover:shadow-xl"
              >
              ...
              {images.length > 1 && (
                <div className="absolute top-2 right-10 sm:top-4 sm:right-16  lg:top-8 flex items-center gap-2 z-10">
                  <button
    ...
    <div className="min-h-screen w-full bg-[#fdfcf9]" ref={mainContainerRef}>
     ...
     <section className="w-full px-3 sm:px-6 lg:px-8 pt-2 mt-36 sm:mt-32 md:mt-34 lg:mt-34 ">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange-60 via-[#fdf6f0] to-green-80/50 transition-colors duration-700 w-full h-[160px] sm:h-[300px] md:h-[340px] lg:h-[380px]">
          ...
          <MilkIcon className="absolute top-8 left-[36%] w-5 h-5 text-orange-600/40 pointer-events-none z-0 hidden sm:block animate-float-leaf-1" style={{ transform: 'scale(1.2)', transformOrigin: 'center' }} />
          <CurdIcon className="absolute top-1/2 left-[40%] w-6 h-6 text-orange-600/30 pointer-events-none z-0 hidden md:block animate-float-leaf-2" style={{ transform: 'scale(1.1)', transformOrigin: 'center' }} />
          <CheeseIcon className="absolute bottom-10 left-[46%] w-5 h-5 text-orange-600/30 pointer-events-none z-0 hidden md:block animate-float-leaf-3" style={{ transform: 'scale(1.3)', transformOrigin: 'center' }} />
          <ButterIcon className="absolute top-6 right-[38%] w-6 h-6 text-orange-600/30 pointer-events-none z-0 hidden md:block animate-float-leaf-4" style={{ transform: 'scale(1.2)', transformOrigin: 'center' }} />
          <PaneerIcon className="absolute bottom-12 right-[20%] w-5 h-5 text-green-400/30 pointer-events-none z-0 hidden lg:block animate-float-leaf-5" style={{ transform: 'scale(1.1)', transformOrigin: 'center' }} />
          <ChipIcon className="absolute top-1/3 left-[15%] w-7 h-7 text-orange-500/20 pointer-events-none z-0 hidden lg:block animate-float-leaf-6" style={{ transform: 'scale(1.1)', transformOrigin: 'center' }} />
          <CookieIcon className="hidden md:block absolute top-5 right-[35%] w-6 h-6 text-green-400/25 pointer-events-none z-0 animate-float-leaf-7" style={{ transform: 'scale(1.2)', transformOrigin: 'center' }} />
          <NamkeenIcon className="absolute bottom-20 left-[30%] w-7 h-7 text-green-400/20 pointer-events-none z-0 animate-float-leaf-8" style={{ transform: 'scale(1.1)', transformOrigin: 'center' }} />
      ...
      <section className="w-full sm:px-6 lg:px-8 mt-6 mb-2">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-1">
          {[
            ...
            { icon: Leaf, title: "Fresh & Pure", sub: "Certified Quality", bg: "bg-green-50", text: "text-green-600", border: "border-green-100" },
          ].map((f, index) => (
            <div 
              key={f.title} 
      ...
      <div className="max-w-auto mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 text-sm py-4 animate-slide-up">
          ...
          <span className="text-emerald-500 font-medium bg-emerald-50 px-3 py-1 rounded-full hover:scale-105 transition-transform duration-300">Dairy Products & Snacks</span>
...
export default DairyProductsAndSnacks;